...
export default function PromoterExportPage() {
    ...
    const handleExport = async () => {
        ...
        setExporting(true);
        try {
            const { content, filename } = await exportService.generateCsv(selectedShift);
    ...
    return (
        <div className="space-y-4">
            <Card className="p-6 text-center">
                ...
                <h3 className="text-lg font-semibold text-stone-900 mb-1 tracking-tight">Export Report</h3>
                <p className="text-sm text-stone-400 mb-5">Download CSV or copy for WhatsApp</p>
            ...
            {shifts.length === 0 && (
                <Card className="p-6 text-center">
                    <p className="text-stone-400 text-sm">No shifts available for export</p>
                </Card>
            )}
