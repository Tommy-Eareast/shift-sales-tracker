...
export default function ShiftEditPage() {
  ...
  if (loading)
    return (
      <div className="flex items-center justify-center py-12">
        <div className="text-stone-400 text-sm">Loading shift data...</div>
      </div>
    );
  if (error)
    return (
  ...
  if (!shift)
    return (
      <div className="flex items-center justify-center py-12">
        <div className="text-stone-400 text-sm">Shift not found</div>
      </div>
    );
  ...
  return (
    <div className="space-y-4 pb-28">
      ...
      <div className="flex items-center gap-2">
        ...
        {shift.note && (
          <p className="text-xs text-stone-400 truncate">{shift.note}</p>
        )}
      </div>
          ...
          <div className="flex items-center justify-between gap-3">
            <div>
              ...
              <p className="text-sm text-stone-900">
                Sold:{" "}
                <span className="font-bold">{summary?.totalCount || 0}</span>
              </p>
            </div>
