...
type Props = {
    ...
    form: { brandMain: string; subCategory: string; fullName: string; price: number };
    onChange: (form: { brandMain: string; subCategory: string; fullName: string; price: number }) => void;
    error: string;
    brands: string[];
...
export function ProductFormModal({
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title={editingProduct ? 'Edit Product' : 'Add Product'} persistent>
            {error && (
